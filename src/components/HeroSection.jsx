        ...
        <section id="hero" className="position-relative min-h-screen flex flex-col items-center justify-center px-4">
            ...
            <div className="container max-w-4xl mx-auto text-center z-10" >
                ...
                <div className="space-y-6 flex flex-col items-center justify-center ">
                    ...
                    <div ref={ref} className="relative w-40 h-40 mx-auto top-3 md:w-72 md:h-56 md:top-10 lg:absolute lg:w-[300px] lg:h-[350px] lg:left-5 lg:top-180 lg:-translate-y-1/2 xl:top-150 xl:left-15  z-0">
                        {inView && (
